...
try:
    APP_ID = config("APP_ID", "27744380", cast=int)
    API_HASH = config("API_HASH", "08f3fd61ccd1aa4aa6ccdb716fb68fed")
    BOT_TOKEN = config("BOT_TOKEN", "6450854583:AAFqTTP_VRQV8H-W0usPGEg3bCetN9tGNP4")
    DEV = 5467555331
    OWNER = config("OWNER", "6065594762")
